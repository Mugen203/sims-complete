...
///     Implements IEntityTypeConfiguration{LecturerEvaluationDetail} to configure the LecturerEvaluationDetail entity in
///     the DbContext.
/// </summary>
    ...
    public void Configure(EntityTypeBuilder<LecturerEvaluationDetail> builder)
    {
        ...
        builder.HasData(
            new
            {
                ...
                EvaluationId =
                    existingEvaluationId, // Foreign Key - EvaluationId, reference existing LecturerEvaluation
