...
public class CourseConfiguration : IEntityTypeConfiguration<Course>
{
    ...
    public void Configure(EntityTypeBuilder<Course> builder)
    {
        ...
        builder.HasData(
            ...
            new
            {
                CourseCode = "COSC113", CourseName = "Elements of Programming", Credits = 3, Department = "Computer Science",
                Level = Level.Level100, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.AmericanHigh,
                Description = "Introduction to fundamental programming concepts.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC115", CourseName = "Introduction to Computer Science I", Credits = 3, Department = "Computer Science",
                Level = Level.Level100, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS1,
                Description = "First course in the computer science introductory sequence.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC116", CourseName = "Introduction to Computer Science II", Credits = 3, Department = "Computer Science",
                Level = Level.Level100, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS2,
                Description = "Second course in the computer science introductory sequence.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC130", CourseName = "Digital Electronics", Credits = 3, Department = "Computer Science",
                Level = Level.Level100, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS3,
            ...
            new
            {
                CourseCode = "COSC230", CourseName = "Database Systems Design", Credits = 3, Department = "Computer Science",
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.GeneralLab1,
                Description = "Principles of database systems design and implementation.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC240", CourseName = "Systems Programming", Credits = 3, Department = "Computer Science",
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.GeneralLab2,
                Description = "Advanced programming concepts in system-level development.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC245", CourseName = "Entrepreneurship and Human Development", Credits = 1, Department = "Computer Science",
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS1,
            ...
            new
            {
                ...
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS2,
            ...
            new
            {
                ...
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS3,
                Description = "Core concepts and principles of operating systems.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC260", CourseName = "System Analysis & Design", Credits = 3, Department = "Computer Science",
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.GeneralLab1,
            ...
            new
            {
                CourseCode = "COSC271", CourseName = "Data Comms & Comp Network I", Credits = 3, Department = "Computer Science",
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.GeneralLab2,
            ...
            new
            {
                CourseCode = "COSC280", CourseName = "Information Systems", Credits = 3, Department = "Computer Science",
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS1,
            ...
            new
            {
                CourseCode = "COSC331", CourseName = "Computer Graphics I", Credits = 3, Department = "Computer Science",
                Level = Level.Level300, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS2,
                Description = "Introduction to computer graphics principles and techniques.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC346", CourseName = "Software Engineering", Credits = 3, Department = "Computer Science",
                Level = Level.Level300, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS3,
                Description = "Principles and practices of software engineering.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC357", CourseName = "Project Planning and Management", Credits = 3, Department = "Computer Science",
                Level = Level.Level300, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.GeneralLab1,
                Description = "Techniques for planning and managing software projects.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC361", CourseName = "Data Structures & Algorithms I", Credits = 3, Department = "Computer Science",
                Level = Level.Level300, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.GeneralLab2,
            ...
            new
            {
                ...
                Level = Level.Level300, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS1,
                Description = "Introduction to research methodologies in computer science.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC370", CourseName = "Operations Research", Credits = 3, Department = "Computer Science",
                Level = Level.Level300, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS2,
                Description = "Application of operations research techniques to computer science problems.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
            ...
            new
            {
                ...
                Level = Level.Level100, CourseCategory = CourseCategory.Cognate, ClassLocation = ClassLocation.GeneralLab1,
            ...
            new
            {
                CourseCode = "COSC257", CourseName = "Computer Architecture & Microprocessor System", Credits = 3, Department = "Computer Science",
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS2,
            ...
            new
            {
                CourseCode = "COSC272", CourseName = "Data Comms & Comp Networks II", Credits = 3, Department = "Computer Science",
                Level = Level.Level200, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.CS3,
            ...
            new
            {
                CourseCode = "COSC430", CourseName = "Computer Simulation and System Modeling", Credits = 3, Department = "Computer Science",
                Level = Level.Level400, CourseCategory = CourseCategory.CoreComputerScience, ClassLocation = ClassLocation.GeneralLab2,
            ...
            new
            {
                CourseCode = "COSC425", CourseName = "Mobile Application Development", Credits = 3, Department = "Computer Science",
                Level = Level.Level400, CourseCategory = CourseCategory.ElectiveComputerScience, ClassLocation = ClassLocation.CS1,
                Description = "Development of mobile applications for various platforms.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC435", CourseName = "Computer and Cyber Forensics", Credits = 3, Department = "Computer Science",
                Level = Level.Level400, CourseCategory = CourseCategory.ElectiveComputerScience, ClassLocation = ClassLocation.CS2,
            ...
            new
            {
                ...
                Level = Level.Level400, CourseCategory = CourseCategory.ElectiveComputerScience, ClassLocation = ClassLocation.CS3,
            ...
            new
            {
                CourseCode = "ACCT210", CourseName = "Introduction to Accounting", Credits = 3, Department = "Accounting",
                Level = Level.Level200, CourseCategory = CourseCategory.Cognate, ClassLocation = ClassLocation.GeneralLab1,
                Description = "Basic accounting principles and practices.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "MATH171", CourseName = "Introductory Maths for Computer Science", Credits = 3, Department = "Mathematics",
                Level = Level.Level100, CourseCategory = CourseCategory.Cognate, ClassLocation = ClassLocation.GeneralLab2,
                Description = "Mathematical concepts relevant to computer science.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "MATH172", CourseName = "Discrete and Continuous Mathematics", Credits = 3, Department = "Mathematics",
            ...
            new
            {
                CourseCode = "AFST205", CourseName = "Introduction to African Music", Credits = 1, Department = "African Studies",
                Level = Level.Level200, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
                Description = "Introduction to the diverse world of African music.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "CMME115", CourseName = "Introduction to Communication Skills", Credits = 2, Department = "Communication",
                Level = Level.Level100, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
                Description = "Basic communication skills for effective interaction.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "ENGL111", CourseName = "Language and Writing Skills I", Credits = 2, Department = "English",
                Level = Level.Level100, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
            ...
            new
            {
                CourseCode = "ENGL112", CourseName = "Language and Writing Skills II", Credits = 2, Department = "English",
                Level = Level.Level100, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
             ...
             new
            {
                CourseCode = "ENGL122", CourseName = "Language and Writing Skills II", Credits = 3, Department = "English",
                Level = Level.Level100, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
                Description = "Further development of language and writing skills.", // Duplication? - You might want to check the course code and name here. // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "FREN121", CourseName = "French for General Communication I", Credits = 2, Department = "French",
                Level = Level.Level100, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
            ...
            new
            {
                CourseCode = "PEAC100", CourseName = "Physical Activity", Credits = 0, Department = "Physical Education",
                Level = Level.Level100, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
            ...
            new
            {
                CourseCode = "PSYC105", CourseName = "Introduction to Psychology", Credits = 3, Department = "Psychology",
                Level = Level.Level100, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
            ...
            new
            {
                CourseCode = "RELB163", CourseName = "Life and Teachings of Jesus", Credits = 3, Department = "Religion",
                Level = Level.Level100, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
            ...
            new
            {
                CourseCode = "RELB250", CourseName = "Principles of Christian Faith", Credits = 3, Department = "Religion",
                Level = Level.Level200, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
            ...
            new
            {
                CourseCode = "RELT385", CourseName = "Introduction to Biblical Foundation Ethics", Credits = 3, Department = "Theology",
                Level = Level.Level300, CourseCategory = CourseCategory.GeneralEducation, ClassLocation = ClassLocation.AmericanHigh,
            ...
            new
            {
                CourseCode = "COSC492", CourseName = "Final Year Project II", Credits = 6, Department = "Computer Science",
                Level = Level.Level400, CourseCategory = CourseCategory.FinalYearProject, ClassLocation = ClassLocation.CS3,
            ...
            new
            {
                CourseCode = "AFST243", CourseName = "Chieftancy and Development", Credits = 1, Department = "African Studies",
                Level = Level.Level200, CourseCategory = CourseCategory.Extra, ClassLocation = ClassLocation.AmericanHigh,
                Description = "Exploration of chieftaincy and its role in development.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC124", CourseName = "Procedural Programming", Credits = 3, Department = "Computer Science",
            ...
            new
            {
                CourseCode = "COSC214", CourseName = "Computer Organization", Credits = 3, Department = "Computer Science",
            ...
            new
            {
                CourseCode = "COSC224", CourseName = "Object-Oriented Programming", Credits = 3, Department = "Computer Science",
            ...
            new
            {
                CourseCode = "COSC360", CourseName = "Web Applications Development", Credits = 3, Department = "Computer Science",
                Level = Level.Level300, CourseCategory = CourseCategory.Extra, ClassLocation = ClassLocation.GeneralLab1,
            ...
            new
            {
                ...
                Level = Level.Level300, CourseCategory = CourseCategory.Extra, ClassLocation = ClassLocation.GeneralLab2,
                Description = "Practical work experience through internship.", // Added Description
                IsActive = true // Added IsActive = true
            },
            new
            {
                CourseCode = "COSC429", CourseName = "Cloud Computing Systems", Credits = 3, Department = "Computer Science",
            ...
            new
            {
                CourseCode = "COSC446", CourseName = "Advanced Network & Systems Administration", Credits = 3, Department = "Computer Science",
            ...
            new
            {
                CourseCode = "COSC455", CourseName = "Artificial Intelligence & Machine Learning I", Credits = 3, Department = "Computer Science",
            ...
            new
            {
                ...
                Level = Level.Level200, CourseCategory = CourseCategory.Extra, ClassLocation = ClassLocation.GeneralLab1,
            ...
            new
            {
                ...
                Level = Level.Level100, CourseCategory = CourseCategory.Extra, ClassLocation = ClassLocation.AmericanHigh,
