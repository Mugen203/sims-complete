...
public class Course
{
    ...
    [MaxLength(10, ErrorMessage = "Course code cannot exceed 10 characters")] // Increased maxLength to 10 for more flexibility
    ...
    /// <summary>
    /// Typical or default location where classes for this course are conducted (e.g., "Lecture Hall", "Online", "Laboratory").
