...
public class LecturerEvaluation
{
    ...
    public DateTimeOffset EvaluationDate { get; set; } =
        DateTimeOffset.UtcNow; // Default value set in parameterless constructor
    ...
    /// </summary>
    public ICollection<LecturerEvaluationDetail>
        EvaluationDetails { get; set; } // Virtual for lazy loading if needed, use HashSet for initialization
