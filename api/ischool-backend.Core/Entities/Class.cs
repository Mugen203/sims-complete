...
public class Class
{
    ...
    public Class()
    {
        ...
        AttendanceRecords =
            new HashSet<AttendanceRecord>(); // Added AttendanceRecords here as well, if attendance is tracked per class instance
    ...
    /// <param name="classLocation">
    ///     Specific location where this class instance is held (overrides default Course location if
    ///     needed).
    /// </param>
    public Class(string classCode, string courseCode, string lecturerId, Semester semester, string academicYear,
