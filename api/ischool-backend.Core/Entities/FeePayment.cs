...
public class FeePayment
{
    ...
    public FeePayment(Guid accountId, decimal amountPaid, PaymentMethod paymentMethod, string paymentReference,
        Semester semester, string academicYear, string createdBy)
    {
        AccountId = accountId;
        ...
        Status = PaymentStatus
            .Pending; // Default status for new payments. Consider if this is always 'Pending' initially.
        CreatedBy = createdBy;
    ...
    public PaymentStatus Status { get; set; } =
        PaymentStatus.Pending; // Default status - consider if Pending is always initial status
    ...
    /// </summary>
    public bool ReceiptIssued { get; set; } // Default to false
