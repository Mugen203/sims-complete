...
/// Tracks when attendance was marked, whether it was student-marked and lecturer-approved, the attendance status, and any relevant notes.
/// </summary>
public class AttendanceRecord
{
    ...
    public AttendanceRecord(string studentId, Guid classSessionId, DateTimeOffset markTime, AttendanceStatus attendanceStatus)
    {
        StudentId = studentId;
    ...
    /// <summary>
    /// Indicates whether the attendance was initially marked by the student themselves (e.g., through a self-check-in system).
    /// Defaults to false, implying lecturer or system-marked attendance.
    /// </summary>
    [Required(ErrorMessage = "StudentMarked is required")]
    public bool StudentMarked { get; set; } = false; // Default to false
    ...
    public bool LecturerApproved { get; set; } = false; // Default to false
    ...
    /// Can be used to provide context or reasons for a particular attendance status (e.g., "Medical Leave", "Late due to traffic").
    ...
    /// </summary>
    public required ClassSession ClassSession { get; set; } // Ensures ClassSession navigation property is always populated
